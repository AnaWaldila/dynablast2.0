classdef Class_Blast
    ...
    % blast_type: type of equation to interprets the blast wave behavior
    % (1 for Friedlander + Cubi, 2 for extended Friedlander)
    ...
    % [4] Rigby, S. E, Tyas, A., Bennett, T., Clarke, S. D., Fay, S. D. The
    % Negative Phase of the Blast Load. International Journal of Protective
    % Structures, 2014.;
    ...
    properties (SetAccess = public, GetAccess = public)
        ...
        eq_p1   = 0;    % Positive phase equation
        eq_p2   = 0;    % Negative phase equation
    ...
    methods
        ...
        function this = Class_Blast(tnt, pmt)
            if (nargin > 0)
                
                % Functions
                this = this.Max_Pressure(tnt, pmt);
                this = this.Min_Pressure(tnt, pmt);
                this = this.Positive_Time(tnt, pmt);
                this = this.Positive_Impulse(tnt, pmt);
                this = this.Exponent(tnt);
                this = this.Negative_Impulse(tnt, pmt);
                this = this.Negative_Time(tnt, pmt);
                this = this.Positive_Equation();
                this = this.Negative_Equation(tnt, pmt);
    ...
    methods
        ...
        function this = Max_Pressure(this, tnt, pmt)
            
            disp("Start - Class_Blast()              - Max_Pressure()");
            ...
            % The determination of max pressure in positive phase is based
            % on the abaco of US Department of Defence
            
            if (equation == 1 || equation == 2 || equation == 5)
            ...
            disp("End   - Class_Blast()              - Max_Pressure()");
            disp(" ");
        ...
        function this = Min_Pressure(this, tnt, pmt)
                                                
            disp("Start - Class_Blast()              - Min_Pressure()");
            ...
            % Import parameters from Class_Paramete
            this.pmt            = pmt;
            Z                   = this.pmt.Z;
            negative            = this.pmt.negative;
                
            % The determination of min pressure in positive phase is based
            % on the abaco of US Department of Defence
            switch negative
                case 0
                    % Do nothing
                        ...
                        switch type
                            ...
                            case 2  %Spherical
                                ...
                                elseif (1.04853 < Z && Z <= 2.8610)
                                    this.pmin = 1000000 * 0.1944 ...
                                        * Z^(-1.45);
                                elseif (2.8610 < Z)
                                    this.pmin = 1000000 * 0.1553 ...
                                        * Z^(-1.208);
                                end
            ...
            disp("End   - Class_Blast()              - Min_Pressure()");
            disp(" ");
        ...
        function this = Positive_Time(this, tnt, pmt)
                                                
            disp("Start - Class_Blast()              - Positive_Time()");
            ...
            disp("End   - Class_Blast()              - Positive_Time()");
            disp(" ");
        ...
        function this = Positive_Impulse(this, tnt, pmt)
                                                
            disp("Start - Class_Blast()              - Positive_Impulse()");
            ...
            % Import parameters from Class_Parametrs
            this.pmt            = pmt;
            Z                   = this.pmt.Z;
            W                   = this.pmt.W;
                        
            % The determination of positive impulse in positive phase is 
            % based on the abaco of US Department of Defence
            ...
            disp("End   - Class_Blast()              - Positive_Impulse()");
            disp(" ");
        ...
        function this = Negative_Impulse(this, tnt, pmt)
                                                
            disp("Start - Class_Blast()              - Negative_Impulse()");
            ...
            % The determination of negative impulse in positive phase is 
            % based on the abaco of US Department of Defence
            switch negative
                case 0
                    % Do nothing
                case 1
                    ...
                    elseif (equation == 5 || equation == 6)
                        syms t
                        this.im = double(int(this.pmax * ...
                            (1 - t / this.td) * ...
                            exp(-this.expo * t / this.td), ...
                            t, this.td, inf));
                    end
                    
            end
            
            disp("End   - Class_Blast()              - Negative_Impulse()");
            disp(" ");
        ...
        % S.I.: s
        function this = Negative_Time(this, tnt, pmt)
                                                
            disp("Start - Class_Blast()              - Negative_Time()");
            ...
            switch negative
                ...
                case 1
                    ...
                    elseif (equation == 2 || equation == 3 || equation == 4)
            ...
            disp("End   - Class_Blast()              - Negative_Time()");
            disp(" ");
        ...
        function this = Exponent(this, tnt)
                                                
            disp("Start - Class_Blast()              - Exponent()");
        ...
        function this = Positive_Equation(this)
            ...
            disp("Start - Class_Blast()              - Positive_Equation()");
            ...
            disp("End   - Class_Blast()              - Positive_Equation()");
            disp(" ");
        ...
        % Funtion to calculate the positive equation
        function this = Negative_Equation(this, tnt, pmt)
                                                
            disp("Start - Class_Blast()              - Negative_Equation()");
            ...
            switch negative
                ...
                case 1
                    ...
                    elseif (equation == 5 || equation == 6)
                        ...
                        this.eq_p2  = this.eq_p1;
                        
                    end
                    
            end
                                               
            disp("End   - Class_Blast()              - Negative_Equation()");
            disp(" ");
