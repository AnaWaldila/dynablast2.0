classdef Class_Effort
    ...
    methods
        ...
        function this = Class_Effort(plate, layer, analysis, material)
            ...
            if (nargin > 0)
                ...
                % Functions
                this = this.General_Displacements(analysis, material);
                this = this.Strain(analysis, material);
                this = this.Stress(layer, material);
                this = this.Matrix_CoeffEffort(layer, material);
                this = this.Effort(plate, analysis);
    ...
    methods
        ...
        % in laminated plate
        function this = General_Displacements(this, analysis, material)
        ...
        function this = Strain(this, analysis, material)
            ...
            switch theory
                ...
                case 5
                    ...
                    this.e0(1,1)    = diff(u0,x) + (1/2) * ...
                                    ((diff(u0,x))^2 + (diff(v0,x))^2 + ...
                                    (diff(w0,x))^2);
                    this.e0(2,1)    = diff(v0,y) + (1/2) * ...
                                    ((diff(u0,y))^2 + (diff(v0,y))^2 + ...
                                    (diff(w0,y))^2);
                    this.e0(3,1)    = diff(u0,y) + diff(v0,x) + ...
                                    diff(u0,x) * diff(u0,y) + ...
                                    diff(v0,x) * diff(v0,y) + ...
                    ...
                    this.g0(1,1)    = ty + diff(w0,y) + ...
                                      diff(v0,y) * ty + diff(u0,y) * tx;
                    this.g0(2,1)    = tx + diff(w0,x) + ...
                                      diff(v0,x) * ty + diff(u0,x) * tx;
        ...
        function this = Stress(this, layer, material)
        ...
        function this = Matrix_CoeffEffort(this, layer, material)
...
%             H                 = sym('H',[6 6]);
        ...
        function this = Effort(this, plate, analysis)
