classdef Class_Solution
    ...
    methods
        ...
        function this = Class_Solution(plate, layer, analysis, pmt, ...
            ...
            if (nargin > 0)
                ...
                % Functions
                this = this.Equation_Disp(analysis, effort, energy, bc);
                this = this.Gallerkin(plate, analysis, pmt, bc);
                this = this.Final_Equation(plate, layer, analysis, ...
                    material);
    ...
    methods
        ...
        function this = Equation_Disp(this, analysis, effort, energy, bc)
            ...
            % 1.4. If the dynamic analysisit is a free vibration analysis, 
            % P = 0
            if (dynamic == 2)
        ...
        function this = Gallerkin(this, plate, analysis, pmt, bc)
        ...
        % =============================================================== %
        % 
        function this = Final_Equation(this, plate, layer, ...
                analysis, material)
            ...
            if (theory == 1 || theory == 2 || theory == 3)
                ...
                elseif (dynamic == 2) && (nonlinear == 0)
                    ...
                    [A,~]               = ...
                        equationsToMatrix(this.final_equation, var);
