classdef Class_SolutionStatic
    ...
    methods
        ...
        function this = Class_SolutionStatic(analysis, pmt, blast, sol)
            
            if (nargin > 0)
                
                % Functions
                this = this.Parameter_Fourier(analysis, pmt, blast, sol);
    ...
    methods
        ...
        function this = Parameter_Fourier(this, analysis, pmt, blast, sol)
            ...
            % Reply P for pmax
            final_galerkin          = subs(final_galerkin, P, pmax);
